...
print(f"min: {lo}, max: {hi}")</code></pre>
<pre><code class="lang-text">min: 1, max: 9</code></pre>
...
<pre><code># squares of even numbers only
...
print(sin(radians(30)))      # sine of 30 degrees</code></pre>
...
<pre><code>with open("output.txt", "w") as f:   # "w" overwrites existing file
    f.write("Line 1\n")
    f.write("Line 2\n")
...
with open("students.csv", "r") as f:
    ...
    for row in reader:
        print(row)</code></pre>
<pre><code class="lang-text">Header: ['name', 'age', 'score']
['Alice', '20', '90']
['Bob', '21', '85']
...
<pre><code class="lang-text">Error: Age cannot be negative!</code></pre>
...
print(divide(10, 2))
print(divide(10, 0))    # triggers AssertionError</code></pre>
<pre><code class="lang-text">5.0
AssertionError: Divisor cannot be zero</code></pre>
...
print(factorial(5))
# factorial(5) → 5 × factorial(4) → ... → 5 × 4 × 3 × 2 × 1</code></pre>
...
print(get_middle([1, 2, 3]))    # three elements</code></pre>
...
print(any(n &gt; 5 for n in nums))         # any &gt; 5?</code></pre>
<pre><code class="lang-text">True
True</code></pre>
